...
export default function SectionHeader({ semiHeading, Heading, children }) {
    return (
        <div className="mt-[130px] flex items-center flex-col gap-[19px] mb-[100px]">
            {/* semi-heading */}
            ...
            {/* more-details */}
            <p className="text-center text-text-15 text-xl font-medium leading-[30px] w-[1050px]">{children}</p>
        </div>
    )
}
