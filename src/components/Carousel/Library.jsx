    ...
    return (
        <div className="grid grid-cols-1 mt-[200px]">
            ...
            <div className="relative px-[50px] pt-[200px] pb-[50px] bg-white rounded-xl shadow-[6px_6px_0px_2px_rgba(30,30,30,1.00)] border-2 border-neutral-800">
                ...
                {/* top-notch */}
                <h3 className="text-[#191919] text-[40px] font-bold leading-[52px]">Library</h3>
                {/* control buttons */}
                ...
                <p className="text-[#4c4c4c] mt-5 text-[20px] font-medium leading-[30px]">Our expansive library is a treasure trove of books, fostering a love for reading and supporting students' literacy development.</p>
            </div>
        </div>
    )
}
