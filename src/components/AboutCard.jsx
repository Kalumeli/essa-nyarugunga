...
export default function AboutCard({ icon, title, details }) {
    return (
        <div className="h-[400px] p-[60px] bg-white rounded-xl shadow-[6px_6px_0px_2px_rgba(30,30,30,1.00)] border-2 border-neutral-800 flex-col justify-start items-start gap-[60px] inline-flex overflow-hidden">
